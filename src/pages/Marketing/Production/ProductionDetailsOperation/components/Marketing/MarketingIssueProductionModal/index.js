...
const MarketingIssueProductionModal = ({ marketingIssueProductionModalShow, setMarketingIssueProductionModalShow, taskId, id, taskName }) => {
    ...
    const handleCancel = () => {
        setMarketingIssueProductionModalShow(false);
    };
    //文件上传
    const props = {
        name: 'file',
...
export default MarketingIssueProductionModal;