...
const ElectricIssueSupplyModal = ({ electricIssueSupplyModalShow, setElectricIssueSupplyModalShow, taskId, id }) => {
    ...
    return <Modal title="作业完成下发" visible={electricIssueSupplyModalShow} onOk={handleOk} onCancel={handleCancel} confirmLoading={confirmLoading}>
        <Form
            {...layout}
...
export default ElectricIssueSupplyModal;