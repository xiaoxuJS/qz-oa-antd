...
const ProductionIssueQuality = ({ productionIssueQuality, setProductionIssueQuality, taskId, id, taskName }) => {
    ...
    return <Modal title="下发" visible={productionIssueQuality} onOk={handleOk} onCancel={handleCancel} confirmLoading = {confirmLoading}>
        <Form
            {...layout}
...
export default ProductionIssueQuality;