...
const ProductionSignForMarketingModal = ({ productionSignForMarketingModalShow, setProductionSignForMarketingModalShow, taskId, id, taskName }) => {
    ...
    return <Modal title="签收" visible={productionSignForMarketingModalShow} onOk={handleOk} onCancel={handleCancel} confirmLoading={confirmLoading}>
        <Form
            {...layout}
...
export default ProductionSignForMarketingModal;